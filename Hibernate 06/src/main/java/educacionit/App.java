...
public class App 
{
    ...
    public static void cargaMany2Many() {
    		BaseRepository<Cuenta> repoCuenta= new BaseRepository<Cuenta>(sessFac, Cuenta.class);
            ...
            */
            ...
            repoCuenta.save(cuenta1001);
            repoCuenta.save(cuenta1002);
            repoCuenta.save(cuenta1003);
            repoCuenta.save(cuenta1005);
    }
    ...
    public static void main( String[] args )
    {
    	...
    	javax.persistence.Persistence.createEntityManagerFactory("pu");
    			        
    	EntityManager em = emf.createEntityManager();
    			        
    	Aeropuerto a1 = new Aeropuerto(new CodigoInternacional("ARG","BSAS"),"Aeropuerto Internacional Ezeiza", 5000);
